...
type KubevipCPConfigSpec struct {
	...
	// KubevipLoadbalancerCIDRs is a list of comma separated cidrs will
	// be used to allocate IP for external load balancer.
	// For example 192.168.0.200/29,192.168.1.200/29
	//+ kubebuilder:validation:Optional
	KubevipLoadbalancerCIDRs *string `json:"kubevipLoadbalancerCIDRs,omitempty"`
	...
	//+ kubebuilder:validation:Optional
	KubevipLoadbalancerIPRanges *string `json:"kubevipLoadbalancerIPRanges,omitempty"`
}
